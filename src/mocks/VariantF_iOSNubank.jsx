...
// F — iOS layout (E) re-skinned in Nubank colors.
// Keeps inset rounded sections + SF Pro feel, swaps blue for Nubank purple.
export default function VariantF({ theme }) {
  ...
  const c = dark
    ? {
        ...
        subtle:   '#48484A',
        accent:   '#A335E5',
        accentSoft: 'rgba(163,53,229,0.16)',
        card:     '#1C1C1E',
        hairline: '#38383A',
        section:  '#2C2C2E',
      }
